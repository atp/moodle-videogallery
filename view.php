...
/**
 * Prints a particular instance of videogallery
 *
...
add_to_log($course->id, 'videogallery', 'view', "view.php?id={$cm->id}", $videogallery->name, $cm->id);

/// Print the page header

$PAGE->set_url('/mod/videogallery/view.php', array('id' => $cm->id));
...
//$PAGE->add_body_class('videogallery-'.$somevar);

// Output starts here
echo $OUTPUT->header();

if ($videogallery->intro) { // Conditions to show the intro can change to look for own settings or whatever
    echo $OUTPUT->box(format_module_intro('videogallery', $videogallery, $cm->id), 'generalbox mod_introbox', 'videogalleryintro');
}
